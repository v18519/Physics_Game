...
public class BasicParticle  {							//////// test particle
	...
	public BasicParticle(float sx, float sy, float vx, float vy, float radius, Color col, float mass, float rollingFriction, BodyType x, float linearDamping, float friction) {
