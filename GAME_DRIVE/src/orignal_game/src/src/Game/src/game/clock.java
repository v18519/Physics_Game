...
public class clock  {
	...
	public clock(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, int numSides, float angularVelocity, BodyType x,  float linearDamping) {
		this(sx, sy, vx, vy, width, height, col, mass, rollingFriction,mkRegularPolygon(width, height),numSides, angularVelocity, BodyType, linearDamping);
	}
	public clock(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, Path2D.Float polygonPath, int numSides, float angularVelocity, BodyType x,  float linearDamping) {
