...
public class chain  {
	...
	public chain(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, int numSides) {
		this(sx, sy, vx, vy, width, height, col, mass, rollingFriction,mkRegularPolygon(width, height),numSides);
	}
	public chain(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, Path2D.Float polygonPath, int numSides) {
