...
public class mount  {
	...
	public mount(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, int numSides) {
		this(sx, sy, vx, vy, width, height, col, mass, rollingFriction,mkRegularPolygon(width, height),numSides);
	}
	public mount(float sx, float sy, float vx, float vy, float width, float height, Color col, float mass, float rollingFriction, Path2D.Float polygonPath, int numSides) {
	...
	public static Path2D.Float mkRegularPolygon(float width, float height) {
		...
		p.lineTo(width,0);
		p.lineTo(width*0.65, height);
		p.lineTo(width*0.35, height);
		p.lineTo(0, 0);
		//p.lineTo(width, 0);
